...
import { LayoutDashboard, CheckSquare, Settings, MessageSquare, ChevronLeft, ChevronRight, Layers, Cpu, FolderSearch, PenLine, Sparkles, Workflow } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { id: "hybrid-pipeline", labelKey: "sidebar.nav.hybridPipeline", Icon: Workflow     },
