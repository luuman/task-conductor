...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      { id: 'overview', icon: <IconLayoutGrid size={16} />, label: 'claudeConfig.nav.overview' },
      { id: 'settings', icon: <IconSettings size={16} />, label: 'claudeConfig.nav.settings' },
    ],
  },
  {
    key: 'extensions',
    ...
    items: [
      { id: 'skills', icon: <IconZap size={16} />, label: 'claudeConfig.nav.skills' },
      { id: 'agents', icon: <IconBot size={16} />, label: 'claudeConfig.nav.agents' },
      { id: 'commands', icon: <IconTerminal size={16} />, label: 'claudeConfig.nav.commands' },
      { id: 'mcp', icon: <IconLink size={16} />, label: 'claudeConfig.nav.mcp' },
    ],
  },
  {
    key: 'security',
    ...
    items: [
      { id: 'hooks', icon: <IconHook size={16} />, label: 'claudeConfig.nav.hooks' },
      { id: 'rules', icon: <IconClipboard size={16} />, label: 'claudeConfig.nav.rules' },
      { id: 'permissions', icon: <IconLock size={16} />, label: 'claudeConfig.nav.permissions' },
      { id: 'env', icon: <IconGlobe size={16} />, label: 'claudeConfig.nav.env' },
    ],
  },
  {
    key: 'system',
    ...
    items: [
      { id: 'plugins', icon: <IconBlocks size={16} />, label: 'claudeConfig.nav.plugins' },
      { id: 'monitoring', icon: <IconActivity size={16} />, label: 'claudeConfig.nav.monitoring' },
      { id: 'trash', icon: <IconTrash size={16} />, label: 'claudeConfig.nav.trash' },
      { id: 'about', icon: <IconCircleHelp size={16} />, label: 'claudeConfig.nav.about' },
    ],
  },
]
