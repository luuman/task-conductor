...
import { IconLogo, IconLayoutGrid, IconSettings, IconSearch, IconMonitor, IconArrowLeft, IconGitBranch } from '../../ui/icon'
...
const NAV_ITEMS: Array<{ key: string; icon: React.ReactNode; i18n: string; shortcut: string; devOnly?: boolean }> = [
  ...
  ...(import.meta.env.DEV ? [
    { key: '/admin/dev', icon: <IconLayoutGrid size={18} />, i18n: 'admin.nav.dev_tools', shortcut: `${modKey}6`, devOnly: true },
  ] : []),
]
